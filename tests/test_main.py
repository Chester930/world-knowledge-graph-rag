...
async def test_lifespan_starts_and_gracefully_cancels_background_workers(monkeypatch):
    ...
    monkeypatch.setattr(main_module.svo_service, "create_entity_name_vector_index", _noop_async)
    monkeypatch.setattr(main_module.svo_service, "create_entity_name_fulltext_index", _noop_async)
