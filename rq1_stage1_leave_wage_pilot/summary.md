...
> 生成時間：2026-09-16T11:31:38.078991+00:00
...
|---|---|---|---|---|---|---|
| **K** | K | 0.0% | 0.0% | 2.98s | 25.77x | $0.0000 |
...
| 題號 | 方法 | 錯誤診斷 | 歸因原因 |
|---|---|---|---|
| 57-AGGR3 | K | 瑕疵 | Harness Exception: ReadError: |
| 57-AGGR4 | K | 瑕疵 | Harness Exception: ReadError: |
| 57-CANARY4 | K | 瑕疵 | Harness Exception: ReadError: |