...
**文獻查證與綁定**：本次新增 6 篇文獻（Hovy et al. 2006 OntoNotes、Speer et al. 2017 ConceptNet、Aguilar et al. 2014、Yih et al. 2015 STAGG、Sakor et al. 2020 Falcon 2.0、Mihindukulasooriya et al. 2020 SLING），皆已下載 PDF 存放於 `docs/參考文獻/03_資訊抽取與本體設計/`，並補上 GitHub 參考專案查證（STAGG 111★／Falcon 2.0 120★／SLING 所在的 IBM/neuro-symbolic-ai 123★／ConceptNet 官方實作 2,952★）；ACE 2005 relation schema 本身為 LDC 標註規範非期刊論文，僅記書目、不下載全文。`02_文獻探討.md` § 2.4.4、`docs/論文/附錄與參考文獻.md`、`docs/參考文獻/03_資訊抽取與本體設計/README.md`、`docs/參考文獻/README.md` 皆已同步更新，並建立雙向連結。
