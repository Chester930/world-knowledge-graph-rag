...
| `17_抽取完整性與召回率驗證/` | `docs/報告/19_SVO抽取完整性自我核對機制設計報告.md`（設計中，尚未實作）；02_文獻探討.md § 2.4.4（RQ4a 延伸）；03_系統設計與方法論.md § 3.1.3「附加規定完整性」段落（2026-08-31 新增） | 🟡 已下載並精讀 2 篇，皆僅 arXiv 預印本；設計提案尚未落地程式碼 |
