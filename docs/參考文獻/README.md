...
| `04_圖遍歷與大節點問題/` | 02_文獻探討.md § 2.4.8（RQ6）；`docs/報告/27_圖遍歷向量引導剪枝機制設計報告.md`（報告26 §4 #4 觸發，RQ6 轉分層實作設計） | 🟢 已下載 1 篇（CatRAG，Findings ACL 2026），另交叉引用 12/02/21 資料夾既有的 G-Retriever／PathRAG／LightRAG／Han 綜述／SAGE；待精讀方法章節 |
